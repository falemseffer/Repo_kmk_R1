...
<head>
<meta charset="utf-8" />
<title>Ecran Modifier Station</title>
	...
	<div>
		...
		<form action="ControleStation" method="post">
			<fieldset>
				...
				<label for="nameStation">Name :<span class="requis">*</span></label>
				<input type="text" id="nameStation" name="nameStation"
					value="${ name }" size="20" maxlength="20" /> <br /> <label
					for="commentStation">Comment :</label> <input type="text"
					id="commentStation" name="commentStation" value="${ comment }"
					size="80" maxlength="20" /> <br />

			</fieldset>
			<input type="submit" value="Update" name="action" /> <input
